...
package body Asynchronous.Tasks is
   ...
   procedure Run_Tests is
      ...
      procedure Test_Waiting_One is
         E : constant Events.Servers.Server := Events.Servers.Make_Event;
         C : constant Event_Client := E.Make_Client;
      ...
      procedure Test_Waiting_Multiple is
         E1, E2 : constant Events.Servers.Server := Events.Servers.Make_Event;
         C1 : constant Event_Client := E1.Make_Client;
         C2 : constant Event_Client := E2.Make_Client;
